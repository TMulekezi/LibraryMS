...
public class BooksDatabaseServer {
    ...
    public BooksDatabaseServer(){
        ...
        try {
            ...
            //TO BE COMPLETED
            this.serverSocket = new ServerSocket(this.thePort, 3, InetAddress.getByName(theIPAddress));
    ...
    public void executeServiceLoop()
    {
        ...
        try {
            ...
            while (true) {
                ...
                BooksDatabaseService newServicethread = new BooksDatabaseService(aSocket);
